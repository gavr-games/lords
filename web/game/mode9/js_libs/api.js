...
function add_building_cell(id,p_num,mx,my,b,card_id,nrotation,nflip,i)	{
	last_executed_api = 'add_building_cell';
				...
				var myDivOver = new Element('div');
				myDivOver.addEvent('click', function(){execute_building(mx,my);});
...
function addBuildingTip(dom_id,id)	{
	...
	addBoardTip(dom_id
		,'<table><tr><td><p class="con_img"><span><img src="../../design/images/buildings/'
			...
			+ '</ul></td></tr></table>'
		,'<p class="pl'+(p_num.toInt()+1).toString()+'"></p>'
			+ '<p style="padding:4px 7px 5px 7px;">'+effects+building_description(building_id)+'</p>'
		,'hintTip buildtip'+id);
}
function addCastleTip(dom_id,id)	{
	...
	var p_num = board_buildings[id]['player_num'];
	addBoardTip(dom_id
		,'<table><tr><td><p class="con_img"><span><img src="../../design/images/buildings/castle_'+p_num+'.png"></span></p></td><td><ul>'
			...
			+ '</ul></td></tr></table>'
		,'<p class="pl'+(p_num.toInt()+1).toString()+'"></p>'
			+ '<p style="padding:4px 7px 5px 7px;">'+building_description(building_id)+'</p>'
		,'hintTip castletip'+id);
}
