...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _wsclient = __webpack_require__(1);
	
	window.WSClient = new _wsclient.WSClient();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var WSClient = exports.WSClient = function () {
	    function WSClient() {
	    ...
	    _createClass(WSClient, [{
	        ...
	        key: "joinPersonalChannel",
	        value: function joinPersonalChannel(user_id) {
	            this.joinChannel("user:" + user_id);
	        }
	    }, {
	        key: "sendChatMessage",
	        value: function sendChatMessage(chatId, msg) {
	            var channelName = "chat:" + chatId;
	            this.channels[channelName].push("new_msg", {
	                msg: msg
	            });
	        }
	    }, {
	        key: "sendGameChatMessage",
	        value: function sendGameChatMessage(gameId, msg) {
	            var channelName = "game:" + gameId;
	            this.channels[channelName].push("new_msg", {
	                msg: msg
	            });
	        }
	    }, {
	        key: "sendBaseProtocolCmd",
	        value: function sendBaseProtocolCmd(params) {
	            this.joinChannel("base");
	            this.sendJSONtoChannel("base", "base_protocol_cmd", params);
	        }
	    }, {
	        key: "sendLoggedProtocolCmd",
	        value: function sendLoggedProtocolCmd(params) {
	            var cmd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "logged_protocol_cmd";
	
	            if (!this.user_id) {
	                var self = this;
	                jQuery.get("/site/ajax/get_user_session.php", function (data) {
	                    self.user_id = JSON.decode(data)["user_id"];
	                    var channelName = "user:" + self.user_id;
	        ...
	        key: "sendGameProtocolCmd",
	        value: function sendGameProtocolCmd(params) {
	            this.sendLoggedProtocolCmd(params, "game_protocol_cmd");
	        }
	    }, {
	        key: "sendPerformance",
	        value: function sendPerformance(params) {
	            this.sendLoggedProtocolCmd(params, "performance");
	        }
	    }, {
	        key: "sendJSONtoChannel",
	        value: function sendJSONtoChannel(channelName, cmd, params) {
	            if (this.debug) {
	        ...
	        value: function getGameStatistic() {
	        ...
	        value: function joinChannel(channelName) {
	            ...
	            channel.on("protocol_raw", function (payload) {
	                _this.handleProtocolRawMessage(payload);
	            });
	
	            channel.on("game_raw", function (payload) {
	                if (_this.debug) {
	                    console.log(payload);
	                }
	                if (!recieve_cmds) return -1;
	            ...
	            channel.on("game_info_raw", function (payload) {
	                var commands = _this.convertFromChars(payload.commands);
	                if (_this.debug) {
	                    console.log(payload);
	                }
	                try {
	            ...
	            channel.on("game_statistic_raw", function (payload) {
	                var commands = _this.convertFromChars(payload.commands);
	                if (_this.debug) {
	            ...
	            channel.on("err", function (payload) {
	        ...
	        key: "leaveChannel",
	        value: function leaveChannel(channelName) {
	        ...
	        key: "handleProtocolRawMessage",
	        value: function handleProtocolRawMessage(payload) {
	            if (this.debug) {
	        ...
	        key: "convertFromChars",
	        value: function convertFromChars(s) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=ws.bundle.js.map