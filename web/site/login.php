		...
		<div id="log_cont">
			<div id="log_form" class="<?php  echo getSeason(); ?>">
				...
				<form action="ajax/authorize_user.php" method="post" id="guest_login_form" onsubmit="return false;">
		    		...
		    		<div class="button"><span class="in_b_1"><p class="in_b_2"><a id="guest_login_b" href="#" class="" onclick="doGuestLogin($('guest_login_b'), '<?= L::login_fields_blank ?>', '<?= L::loading_text ?>');return false;"><?= L::login_guest_enter ?></a></p></span></div>
		        </form>
