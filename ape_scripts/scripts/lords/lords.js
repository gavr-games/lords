...
Ape.addEvent("init", function() {
    ...
    Ape.addEvent("deluser", function(user) {
        ...
        if ($chk(user.user_id))
            if ($chk(users_by_id[user.user_id]))
                if (user.getProperty('pubid') == users_by_id[user.user_id]) { //make offline
    ...
    Ape.registerHookCmd("connect", function(params, cmd) {
        ...
        request.getContent(function(result) {
            ...
            if ($chk(ans.user_id) && ans.user_id != "")
                if ($chk(users_by_id[ans.user_id.toInt()])) { //another pubid in array
