...
<body>
	<div id="reg_cont">
		...
		<form action="" method="post" id="reg_form" onsubmit="return false;">
	    	...
	    	<span class="logfields">Еще раз пароль:<p class="txtfield"><input class="pas" type="password" name="pass2" id="pass2_i"></p></span>
	    	</div>
	    ...
	    <div class="button back" style="margin-right:30px;"><span class="in_b_1"><p class="in_b_2"><a id="to_main" href="#" onclick="if (!parent.window_loading){ parent.load_window('site/login.php','left'); doLoading($('to_main'));}return false;">На главную</a></p></span></div>
