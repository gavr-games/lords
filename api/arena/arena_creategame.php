...
<span class="gmsheader gmstopheader"> - <?= L::arena_creategame_create_game ?></span><br /><br />
   ...
   <table>
     ...
     <a href="#" id="crgame_button" onclick="validateForm($('crgame_button'), '<?= L::signup_pass_mismatch ?>', '<?= L::login_fields_blank ?>');return false;" class="crtgm btn"><?= L::arena_creategame_create ?></a>
