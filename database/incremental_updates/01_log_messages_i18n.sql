...
(2, 'building_repair', '{building0} восстанавливает {health1}'),
(1, 'building_repair', '{building0} is repaired {health1}'),
...
(2, 'take_subsidy', 'Взял субсидию: {building0} {health1}'),
(1, 'take_subsidy', 'Sells stones: {building0} {health1}'),
...
(2, 'unit_becomes_vampire', '{unitname0} становится вампиром'),
(1, 'unit_becomes_vampire', '{unitname0} turns into a vampire'),
